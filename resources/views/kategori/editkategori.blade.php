...
@section('content')
    ...
    <section class="content">
      <div class="row">
	   ...
	   <form action="{{ url('updatekategori/'.$row2->idKategory) }}" class="form-horizontal" method="post" enctype="multipart/form-data">
	   {{ csrf_field() }}
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-tags"></i> edit data kategori</h3>
