		...
		<div class="box-body">
           ...
           <div class="form-group">
               ...
               <select name="idProduk_fk" class="form-control">
                ...
                <input title="Tanggal"type="text" name="tgl_order" autocomplete="off" required class="form-control" value="{{$row2->tgl_order}}">
				</div><br>
                <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-tags"></i> Detail Order </span>
                <input title="Detai "type="text" name="detail_order" autocomplete="off" required class="form-control" value="{{$row2->detail_order}}">
				</div><br>
                <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-tags"></i> Jumlah Order</span>
                <input title="Jumlah"type="text" name="jumlah_order" autocomplete="off" required class="form-control" value="{{$row2->jumlah_order}}">
				</div><br>
                <div class="input-group">
                ...
                <input title="Total "type="text" name="total" autocomplete="off" required class="form-control" value="{{$row2->total}}">
				</div><br>
